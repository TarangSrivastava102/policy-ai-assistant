...
def get_employee_submissions(employee_email):
    ...
    return [
        r for r in rows
        if str(r.get("Employee Email", "")).strip().lower() == email
    ]
...
def upload_to_drive(
    ...
    filename = (
        f"{safe_employee}_{claim_month}_{safe_type}_"
        f"Invoice_{invoice_no}_{uuid.uuid4().hex[:8]}{suffix}"
    )
...
def reimbursement_portal():
    ...
    if today.day > REIMBURSEMENT_CUTOFF_DAY:
        ...
        st.warning(
            f"The {calendar.month_name[today.month]} "
            f"{today.year} submission window has closed. "
    ...
    if submit:
        ...
        # IMPORTANT FIX:
        #
        # DO NOT reject the submission after the 22nd.
        #
        # After the 22nd, current_submission_month() automatically
        # moves the active submission month to the following month.
        #
        # Example:
        # August 23 -> September submission window.
        #
        # The old code incorrectly blocked the submit button here.
        # ====================================================
        ...
        for mkey in selected_keys:
            ...
            if not types:
                ...
                errors.append(
                    f"Please select at least one reimbursement type for "
                    f"{month_label(y, m)}."
                )
        ...
        # ----------------------------------------------------
        # Prevent duplicate month claims
        # ----------------------------------------------------
        ...
        st.markdown(
            ...
            <div class="success-card">
                ...
                <div class="success-text">
                    ...
                    HR has been notified by email and the supporting
                    documents have been stored in Google Drive.
...
if not st.user.is_logged_in:
    ...
    if logo_path.exists():
        ...
        logo_html = (
            ...
            'border-radius:20px;background:#6547ed;color:#fff;'
            'display:flex;align-items:center;justify-content:center;'
            'font-size:50px;font-weight:800;">G</div>'
        )
...
with col_main:
    ...
    st.markdown(
        '<div class="brand-title">GM Policy Assistant</div>',
        unsafe_allow_html=True
    )
            ...
            if message["role"] == "assistant":
                ...
                if (
                    ...
                    st.warning(
                        ...
                        "You can contact HR or schedule a confidential 15-minute discussion."
                    )
            ...
            st.session_state.messages.append(
                {
                    ...
                    "content":
                        ...
                        "Employment Agreement terms prevail where applicable.*"
                }
            )
