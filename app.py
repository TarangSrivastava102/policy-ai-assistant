...
def calculate_eligible(
    reimbursement_type,
    amount
):

    limit = REIMBURSEMENT_TYPES[
        reimbursement_type
    ]["monthly_limit"]
...
def google_clients():
    ...
    if not GOOGLE_LIBS_AVAILABLE:
        ...
        raise RuntimeError(
            ...
            "Add gspread, google-auth and "
            "google-api-python-client to requirements.txt."
        )


    # --------------------------------------------------------
    # SUPPORT THE CURRENT STREAMLIT SECRETS STRUCTURE:
    #
    # [google_service_account]
    #
    # --------------------------------------------------------

    service_account_section = None

    try:

        if "google_service_account" in st.secrets:

            service_account_section = dict(
    ...
    if service_account_section:
        ...
        raise RuntimeError(
            "Google service account is missing. "
            "Your Streamlit Secrets must contain either "
            "[google_service_account] or "
            "GOOGLE_SERVICE_ACCOUNT_JSON."
        )
    ...
    try:
        ...
        raise RuntimeError(
            "Google service account credentials could not "
            f"be initialized: {e}"
        )
...
def latest_claimed_month_index(
    employee_email
):

    rows = get_employee_submissions(
        employee_email
    )
...
def get_eligible_month_options(
    employee_email
):
...
def save_reimbursement_to_google(
    submission
):
...
def send_reimbursement_hr_email(
    submission
):
        ...
        ">
            ...
            ">
                ...
                ">
                    ...
                    and process the reimbursement as per
                    company policy.
    ...
    msg.set_content(
        ...
        f"New reimbursement submission "
        f"from {submission['employee_name']}.\n\n"
...
Your ONLY source of policy information is
the Germane Media LLC Employee Policy Handbook below.

Do not use general HR knowledge, internet information,
assumptions, or outside sources.

1. Answer strictly from the handbook.
2. Do not invent policy.
3. If the question cannot be answered from the handbook,
respond exactly:
...
def reimbursement_portal():
    ...
    st.markdown(
        ...
        <div class="portal-hero">
            ...
            <div class="portal-subtitle">
                ...
                Submit eligible claims, upload supporting bills
                and review your reimbursement before sending it to HR.
    ...
    st.markdown(
        ...
        <div class="rule-strip">
            ...
            <span>
                ...
                You may claim a maximum of 3 months
                in one submission.
                After a submission, the next reimbursement
                window opens after 3 months.
                If you miss a month, the oldest month
                eventually falls outside the 3-month window.
    ...
    st.markdown(
        ...
        <div class="section-head">
            ...
            <div class="section-caption">
                ...
                You can claim multiple reimbursement
                types for the same month.
        ...
        st.markdown(
            ...
            <div class="month-card">
                ...
                <div class="month-caption">
                    ...
                    Choose one or more reimbursement
                    types for this month.
                ...
                if config["max_invoices"] == 1:
                    ...
                    if (
                        ...
                        st.caption(
                            ...
                            "Eligible amount is capped "
                            "at ₹1,000 for this reimbursement "
                            "type and month."
    ...
    st.markdown(
        ...
        <div class="section-head">
            ...
            <div class="section-caption">
                ...
                The final summary will be sent
                to HR after submission.
    ...
    if all_items:
        ...
        # IMPORTANT FIX:
        #
        # DO NOT USE st.html(review_html)
        #
        # st.markdown with unsafe_allow_html renders
    ...
    declaration = st.checkbox(
        ...
        "I confirm that the information submitted "
        "is correct and the uploaded documents are "
        ...
        with st.spinner(
            ...
            try:
                ...
                st.error(
                    ...
                    "Please check the Google Drive/Sheet and "
                    "email configuration. "
                    f"Technical details: {e}"
    ...
    st.markdown(
        ...
        <div class="info-card">
            ...
            ">
                ...
                Your chat session is associated
                with your authenticated employee account.
            ...
            if message["role"] == "assistant":
                ...
                if (
                    ...
                    st.warning(
                        ...
                        "You can contact HR or schedule "
            ...
            st.session_state.messages.append(

                {
                    ...
                    "content":
                        ...
                        "\n\n---\n"
                        "*Notice: Answers are derived "
                        "from the Germane Media LLC "
                        "Policy Handbook. Employment Agreement "
                        "terms prevail where applicable.*"
