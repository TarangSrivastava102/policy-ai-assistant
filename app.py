...
/* ============================================================
   ...
   KEEPING ITS EXISTING DESIGN UNCHANGED
   ============================================================ */
...
/* ============================================================
   POLICY ASSISTANT THEME
   RESTORED TO THE EARLIER SOFT PURPLE DESIGN
   ============================================================ */

/* Main Policy Assistant column */
div[data-testid="stColumn"]:has(.policy-theme-anchor) {
    background:
        radial-gradient(
            circle at 10% 5%,
            rgba(112,72,237,.055),
...
/* Right Policy Assistant column */
div[data-testid="stColumn"]:has(.policy-right-anchor) {
    background:
        radial-gradient(
            circle at 90% 10%,
            rgba(112,72,237,.045),
...
.policy-privacy {
    ...
    color: #596274;
    margin-bottom: 18px;
    box-shadow: 0 5px 18px rgba(91,75,234,.035);
}
...
.policy-side-card {
    ...
    border-radius: 16px;
    padding: 18px;
    box-shadow: 0 7px 24px rgba(32,35,58,.045);
    margin-bottom: 16px;
}
...
/* Policy category / suggested question buttons */
...
/* Purple accents for policy area */
div[data-testid="stColumn"]:has(.policy-theme-anchor)
div[data-testid="stButton"] button {
    border-color: #e0dbf8;
}
...
div[data-testid="stChatInput"] {
    border-color: #ded8f7;
    box-shadow: 0 6px 22px rgba(91,75,234,.06);
}

div[data-testid="stColumn"]:has(.policy-theme-anchor)
div[data-testid="stChatInput"]:focus-within {
    border-color: #6547ed;
    box-shadow: 0 0 0 1px #6547ed;
}
...
def upload_to_drive(
    ...
    filename = (
        f"{safe_employee}_{claim_month}_"
        f"{safe_type}_Invoice_{invoice_no}_"
...
def reimbursement_portal():
    ...
    with c3:
        ...
        deadline = (
            "Next month"
            if today.day > REIMBURSEMENT_CUTOFF_DAY
            else f"{calendar.month_name[today.month]} {REIMBURSEMENT_CUTOFF_DAY}"
        )
    ...
    if today.day > REIMBURSEMENT_CUTOFF_DAY:
        ...
        st.success(
            f"Reimbursement submissions are open until "
            ...
            for rtype in selected_types:
                        ...
                        <div class="type-subtitle">
                            {
                                ...
                                'No monthly cap • multiple invoices allowed'
                            }
                        </div>
                    """,
                    unsafe_allow_html=True,
                ...
                if config["max_invoices"] == 1:
                    ...
                    if amount > 0 and eligible < amount:
                        ...
                        st.caption(
                            "Eligible amount is capped at ₹1,000 "
                            "for this reimbursement type and month."
                        )
    ...
    if submit:
        ...
        if today.day > REIMBURSEMENT_CUTOFF_DAY:
            ...
            errors.append(
                f"The current submission window has closed. "
                f"Please submit in {calendar.month_name[nm]} "
                f"{ny}, before the 22nd."
            )
        ...
        submission_id = (
            f"RMB-{datetime.now().strftime('%Y%m%d')}-"
        ...
        with st.spinner(
            ...
            try:
                ...
                sheet_url = save_reimbursement_to_google(
                    submission
                )
        ...
        ">
            ...
            <div>
                ...
                <p style="
                    ...
                    max-width:600px;
                ">
                    Get accurate policy answers, submit employee reimbursements
                    and connect directly with HR.
                </p>
            ...
            <div style="
                ...
                border-radius:22px;
                padding:38px;
                box-shadow:0 14px 40px rgba(32,35,58,.08);
            ">
...
with col_main:
    ...
    # Anchor used only to scope the purple Policy Assistant theme.
    st.markdown(
        '<div class="policy-theme-anchor"></div>',
        unsafe_allow_html=True
    )

    st.markdown(
        '<div class="policy-brand-title">'
        'GM Policy Assistant'
        '</div>',
        unsafe_allow_html=True
    )
...
with col_right:
    ...
    # Anchor used only to scope the purple Policy Assistant theme.
    st.markdown(
        '<div class="policy-right-anchor"></div>',
        unsafe_allow_html=True
    )
    ...
    st.markdown(
        ...
        <div class="policy-side-card">
            ...
            <div class="policy-side-title">
                📅 Schedule HR Discussion
            </div>

            <div class="policy-side-text">
